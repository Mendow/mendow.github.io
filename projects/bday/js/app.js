$(function () {
    ...
    var code = ["Матвей тебя любит", "Успехов в любом проекте", "Быстрой сети", "5г интерент в часы", "респонсив дисижн в лайф", "ТЫ СУПЕР СТАР ВЕЧНО МОЛОДОЙ", "СЧАСТЬЯЗДОРОВЬЯ", "ЛУЧШИЙ БРАТ НА СВЕТЕ", "ОБНИМАШКИ", "КОТИКИ", "இڿڰۣ-ڰۣ—", "[̲̅$̲̅(̲̅ιοο̲̅)̲̅$̲̅]", "♪┏(°.°)┛┗(°.°)┓┗(°.°)┛┏(°.°)┓ ♪", "=^..^=", "-`ღ´-", "龴ↀ◡ↀ龴", "<3"];
